    ...
    <div id="viewable">
        ...
        <div id="midBar">
            ...
            <div id="testArea" role="navigation" tabindex="-1">
                <table>
                    <tr>
                        <th role="link" class="container" id="link1" tabindex="1"><a href="./textalt/index.app"> 1.1 Text Alternatives. </a></th>
                    </tr>
                    <tr>
                        <th role="link" class="container" id="link2" tabindex="2"><a href="./timebased/index.app"> 1.2 Time Based Media. </a></th>
                    </tr>
                    <tr>
                        <th role="link" class="container" id="link3" tabindex="3"><a href="./adaptable/index.app"> 1.3.1 Info and Relationships. </a></th>
                    </tr>
                    <tr>
                        <th role="link" class="container" id="link4" tabindex="4"><a href="./adaptable/index2.app"> 1.3.2 Meaningful Sequences. </a></th>
                    </tr>
                    <tr>
                        <th role="link" class="container" id="link5" tabindex="5"><a href="./adaptable/index3.app"> 1.3.3 Sensory Characteristics.</a></th>
                    </tr>
                    <tr>
                        <th role="link" class="container" id="link6" tabindex="6"><a href="./distin/index.app"> 1.4 Distinguishable.</a></th>
                    </tr>
                </table>
            </div>
            <!-- test area -->
